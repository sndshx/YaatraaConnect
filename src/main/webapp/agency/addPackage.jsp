    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-10 fade-in-up">
            <div class="flex items-center gap-2 text-accent mb-4">
                ...
                <span class="text-[10px] font-bold uppercase tracking-[0.2em] text-white/40">Add New</span>
            </div>
            <h1 class="text-4xl font-serif font-bold text-white">Create <span class="italic text-accent">Experience</span></h1>
        </div>
            ...
            <form action="${pageContext.request.contextPath}/agency/packages/" method="POST" class="space-y-8">
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <label class="cursor-pointer"><input type="radio" name="type" value="trekking" class="hidden peer" checked>
                        ...
                        <label class="cursor-pointer"><input type="radio" name="type" value="hotel" class="hidden peer">
                            <div class="p-5 rounded-2xl border border-white/10 bg-white/[0.02] text-center peer-checked:border-accent peer-checked:bg-accent/10 transition-all hover:bg-white/5">
                        ...
                        <label class="cursor-pointer"><input type="radio" name="type" value="travel" class="hidden peer">
                            <div class="p-5 rounded-2xl border border-white/10 bg-white/[0.02] text-center peer-checked:border-accent peer-checked:bg-accent/10 transition-all hover:bg-white/5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="title" required class="w-full h-[50px] bg-white/5 border border-white/10 rounded-xl px-4 text-sm text-white focus:border-accent outline-none transition-all placeholder-white/20" placeholder="e.g., Annapurna Base Camp Trek">
                </div>

                <div class="grid grid-cols-3 gap-6">
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-white/40 uppercase tracking-[0.2em]">Price ($)</label>
                        <input type="number" name="price" required step="0.01" min="0" class="w-full h-[50px] bg-white/5 border border-white/10 rounded-xl px-4 text-sm text-white focus:border-accent outline-none transition-all" placeholder="1299">
                    </div>
                    <div class="space-y-1.5">
                        <label class="text-[9px] font-bold text-white/40 uppercase tracking-[0.2em]">Duration (Days)</label>
                        <input type="number" name="duration" min="1" value="1" class="w-full h-[50px] bg-white/5 border border-white/10 rounded-xl px-4 text-sm text-white focus:border-accent outline-none transition-all">
                    </div>
                    <div class="space-y-1.5">
                        ...
                        <select name="difficulty" class="w-full h-[50px] bg-[#0a2540] border border-white/10 rounded-xl px-4 text-sm text-white focus:border-accent outline-none">
                            <option value="">Select</option><option value="easy">Easy</option><option value="moderate">Moderate</option><option value="hard">Hard</option><option value="extreme">Extreme</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="location" class="w-full h-[50px] bg-white/5 border border-white/10 rounded-xl px-4 text-sm text-white focus:border-accent outline-none transition-all placeholder-white/20" placeholder="Annapurna Region">
                </div>

                <div class="space-y-1.5">
                    <label class="text-[9px] font-bold text-white/40 uppercase tracking-[0.2em]">Description</label>
                    <textarea name="description" rows="5" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:border-accent outline-none transition-all placeholder-white/20 resize-none" placeholder="Describe the experience..."></textarea>
                </div>
                ...
                <div class="flex items-center justify-between pt-6 border-t border-white/5">
                    ...
                    <button type="submit" class="px-10 py-4 bg-accent text-primary-dark rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white transition-all shadow-xl shadow-accent/20">Create Package</button>
                </div>
            </form>
        </div>
    </div>
